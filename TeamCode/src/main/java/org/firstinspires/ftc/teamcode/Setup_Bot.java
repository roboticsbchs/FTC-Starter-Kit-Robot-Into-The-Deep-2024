...
public class Setup_Bot extends LinearOpMode {
    ...
    RobotState currentState = RobotState.STEADY_STATE;
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            //  state transitions based on gamepad input
                ...
                currentState = RobotState.PICKUP_POSITION;
            } else if (gamepad1.b) {
                currentState = RobotState.DRIVE_POSITION;
                if (gamepad1.x) {
                    currentState = RobotState.START_POSITION;
                }
            } else if (gamepad1.x) {
                currentState = RobotState.SCORE_POSITION;
            }
