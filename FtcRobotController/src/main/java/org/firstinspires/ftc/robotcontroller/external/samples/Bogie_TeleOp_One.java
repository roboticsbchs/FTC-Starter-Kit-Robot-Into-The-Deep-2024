...
class Bogie_TeleOp_One extends LinearOpMode {
    ...
    public Servo elbow = null; //the active intake servo
    public Servo wrist = null; //the wrist servo
    public Servo claw = null; //the claw servo


    // Values for awrm power and encoder motion. Added by Pinnacle.
    ...
    public void runOpMode() {
        ...
        elbow = hardwareMap.get(Servo.class, "elbow");// Servo 0
        wrist = hardwareMap.get(Servo.class, "wrist");// Servo 1
        claw = hardwareMap.get(Servo.class, "claw");// Servo 2
        ...
        elbow.setPosition(MIDDLE);
        wrist.setPosition(MIDDLE);
        claw.setPosition(MIDDLE);
...
// retracting the slide with left gamepad
            ...
            if (gamepad1.left_trigger > ACTIVE_TRIGGER) {
                wrist.setPosition(THREEQUARTER);
            } else {
                if (gamepad1.right_trigger > ACTIVE_TRIGGER) {
                    wrist.setPosition(QUARTER);
                }
            }
