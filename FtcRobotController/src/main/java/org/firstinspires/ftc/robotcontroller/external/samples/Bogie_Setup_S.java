...
@TeleOp(name="Basic: SETUP", group="Linear OpMode")
public class Bogie_Setup_S extends OpMode  {
    ...
    private int tiltMaxPosition = 5870;
    ...
    final double WRIST_TUCK = 0.1;  // servo ~= 0
    ...
    final int SLIDE_FULL = 2000; // Full slide extention
...
//        double yaw = -gamepad1.right_stick_x;
        ...
        double yaw = 0;
            ...
            if (gamepad1.dpad_right) { // 🔘 D-Pad Right
                ...
                if (current_slide_location + slideTicks < SLIDE_FULL) {
...
// retracting the slide with left gamepad
            if (gamepad1.dpad_left) { // 🔘 D-Pad Left
                int current_slide_location = slideMotor.getCurrentPosition();
                if (current_slide_location - slideTicks > slideStartPosition) {
                    slideMotor.setTargetPosition(current_slide_location - slideTicks);
                } else {
                    slideMotor.setTargetPosition(slideStartPosition);
                }
